 ...
 */
   ...
   *
   * @since        1.4.2
   * @version      3.5.2    Updated: addressed all WCAG bugs
   */
?>
<div id="ud-id-foot" class="ud-wrapper--grid ud-gtr-foot">
  <footer class="item--full ud-norm--footer" role="contentinfo" aria-label="UD branded footer content" itemscope="" itemtype="https://schema.org/WPFooter">
    <div class="ud-grid--2 uflex--aic">
      ...
      <div role="navigation" aria-label="Social related links" class="ud-footer--social" itemscope itemtype="https://schema.org/SiteNavigationElement">
        <?php
  ...
  <div class="item item--full ud-footer--legal" role="navigation" aria-label="Legal related links and information" itemscope itemtype="https://schema.org/SiteNavigationElement">
    <ul>
      <li>&copy; <span itemprop="copyrightYear"><?php echo Date('Y'); ?></span>&nbsp;<span itemprop="copyrightHolder" itemscope itemtype="https://schema.org/University"><span id="udid_cr" class="ud_copyright" itemprop="University of Delaware">University of Delaware</span></span></li>
      ...
      <li><a href="https://www.udel.edu/home/legal-notices/accessibility/"><span id="udid_an" class="ud_copyright">Accessibility</span></a></li>
    </ul>
  </div>
</div>
<svg aria-hidden="true" focusable="false" xmlns="https://www.w3.org/2000/svg" width="256" height="256" viewBox="0 0 256 256">
