      ...
      <div id="postbox-container-2" class="postbox-container">
        ...
        // If no tab or header
          ...
          switch ( $current_tab ) {
            case 'footer':
        ?>
          <div id="udt_footer_settings" class="postbox tabPanel panel" aria-labelledby="tab1" role="tabpanel" aria-hidden="false" aria-labelledby="label_udt_footer_settings">
        <div class="inside">
          <?php
        ...
        ?>
          <div id="udt_about_settings" class="postbox tabPanel" role="tabpanel" aria-labelledby="label_udt_about_settings">
            <div class="inside">
              ...
              <p>The <?php echo esc_html( UDTBP_NAME, UDTBP_NAME ); ?> plugin allows a University department or college to display the official University of Delaware branded header and footer on a WordPress website.</p>
