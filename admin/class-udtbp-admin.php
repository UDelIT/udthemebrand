...
if ( ! class_exists( 'udtbp_Admin' ) ) :
  class udtbp_Admin {
     ...
     *
     * @since    3.0.1
     * @version  2.0.0          Removed select box and replaced with text field
     * @access   private
    ...
    */
     ...
     * This function is used to:
      ...
      *
      * @since        3.0.0
      * @version      1.0.3              Deprecated {@link enqueue_styles_ie()} function and moved related code here.
     ...
     * Incorporated into to admin {@link enqueue_styles()} {@link public function enqueue_styles_ie()} {@link bkup/deprecated_functions}
     * p
     * @since       3.0.0
  ...
  */
  public function udtbp_admin_menu() {
    ...
    $page_title = __( 'UDTheme Branding Settings', $this->udtbp );
