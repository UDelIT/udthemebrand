/**
  * SVG X USE JS
  * IE 11 Polyfill for referencing external SVGs in <use> elements.
  *
  * Refactored by Epicycle23 <https://github.com/Epicycle23> 3.16.19
  *
  * Only the cache uses the normalized url/key now since casing may matter
  * depending on the server so if the issue of loading/adding the svg multiple
  * times is related to the href format this may help
  *
  * Unrelated to this problem but maybe worth mentioning:
  * processed elements get marked with a data attribute so they won't get updated
  * every 100 ms
  *
  * Instead of getElementsByTagName it uses querySelectorAll now and only searches
  * for use elements without the data attribute (svg > use:not([data-svgxused])
  * - IE9+ is fine for me
  *
  * Element processing can be called from anywhere which allows me to process
  * elements that have been loaded via ajax, this prevents "flickering" of icons
  * in IE10 at least as long as the svg has already been added/requested

  * @copyright Copyright (c) 2017 IcoMoon.io
  * @license   Licensed under MIT license
  * {@link https://github.com/Keyamoon/svgxuse}
  * {@see https://github.com/Keyamoon/svgxuse/issues/50}
  * @version   1.2.6
  * @since   3.5.0
*/
